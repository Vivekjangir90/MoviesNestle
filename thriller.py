...
def app():
    ...
    url = "https://api.themoviedb.org/3/discover/movie?api_key=1b46d8d88c680c018f026ea039d36f98&with_genres=53&language=en-US&page={}".format(st.session_state.page_number)
